...
ALTER TABLE answer_quality_cases DROP CONSTRAINT IF EXISTS answer_quality_cases_correction_fk;
...
ALTER TABLE conversation_feedback DROP COLUMN IF EXISTS cleared_at;
