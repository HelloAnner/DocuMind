// 移植自 apps/api-rs/src/agent/verification_prompt.rs —— 提示词逐字保留
export const INVENTORY_SYSTEM = `You extract a complete premise inventory from an enterprise document answer. Do not judge support and do not correct the answer.
...
export const PREMISE_SYSTEM = `You are the adversarial premise-provenance auditor for an enterprise document answer.
...
export const PRIMARY_SYSTEM = `You are an independent claim-level grounding verifier for enterprise document answers.
...
export const REFEREE_SYSTEM = `You are the final independent adjudicator for an enterprise document answer.
