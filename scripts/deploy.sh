...
for required_key in \
  ...
  AGENT_MAX_REACT_STEPS AGENT_MAX_REPAIR_ATTEMPTS AGENT_TOTAL_TIMEOUT_SECONDS; do
  upsert_env_var "\$required_key" "\$(release_env_value "\$required_key")"
done
for agent_key in \
  AGENT_MAX_QUERIES_PER_STEP AGENT_MAX_HISTORY_TURNS \
